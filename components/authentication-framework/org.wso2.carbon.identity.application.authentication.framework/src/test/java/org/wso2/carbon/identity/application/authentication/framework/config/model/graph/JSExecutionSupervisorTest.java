...
public class JSExecutionSupervisorTest {
    ...
    public void testMonitor() {
        ...
        try {
            ...
            long elapsedTime = supervisor.competed(identifier);
    ...
    public void testMonitorNegative() throws InterruptedException {
        ...
        try {
            ...
            int i = 0;
            do {
                LOG.info("Waiting for the test to finish : " + i);
                Thread.sleep(1000L);
                i++;
            } while (testExecutionThread.isAlive() && i < 10);
            Assert.assertTrue("The monitor should have killed the testExecutionThread thread but it didn't happen.",
    ...
    public void testMonitorWithAlreadyElapsedTime() {
        ...
        try {
            ...
            long totalElapsedTime = supervisor.competed(identifier);
